...
class GameData {
  ...
  static const List<String> coupleQuotes = [
    ...
    "I love you for everything you are, and for everything we are together.",
    "You are my greatest accomplishment and my favorite distraction.",
    "I'm much more me when I'm with you.",
    "I love you because the entire universe conspired to help me find you.",
    "You are the best gift I've ever received.",
    "My heart is a garden and you are the only flower.",
    "I love you like a love song, baby.",
    "You had me at hello.",
    "I want to hold your hand for 80 years and then some.",
    ...
    "You are my soulmate.",
    "I want to spend every single second of my life with you.",
    ...
    "You are my constant.",
    "I'm so happy I found my way to you.",
    "You are my everything and more.",
    "I love you more than life itself.",
    "You are my home.",
    "I want to walk with you through all of life's paths.",
    "You are my sunshine.",
    "I love you infinitely.",
    "You are my heart.",
    "I'm forever yours.",
    "You are my love, my life, my everything.",
    "I love being with you more than anything else in the world.",
  ];
